...
void DesStatePublisher::initializeSubscribers() {
    lidar_alarm_subscriber_ = nh_.subscribe("lidar_alarm", 1, &DesStatePublisher::myAlarmCallback, this);
}

void DesStatePublisher::myAlarmCallback(const std_msgs::Bool& alarm_msg) { 
